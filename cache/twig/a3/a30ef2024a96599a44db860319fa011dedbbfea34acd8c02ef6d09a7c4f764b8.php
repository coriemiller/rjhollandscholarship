...
class __TwigTemplate_4b904b220b265118574ccc407948355aaf1c7a7d79d9ccc6927f77cb25d4ee98 extends Twig_Template
{
    ...
    ";
        ...
        // line 10
        echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->dump($this->env, $context, (isset($context["show_form_labels"]) ? $context["show_form_labels"] : null));
        echo "
...
";
    ...
    {
        return "<form name=\"simple_form\" id=\"simple_form\" class=\"form-horizontal\" action=\"https://getsimpleform.com/messages?form_api_token={{ token | e('html_attr') }}\" method=\"post\">
